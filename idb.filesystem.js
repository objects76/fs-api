...
(function (exports) {
  ...
  const NOT_IMPLEMENTED_ERR = new MyFileError({ code: 1000, name: "Not implemented" });
  const NOT_FOUND_ERR = new MyFileError({ code: FileError.NOT_FOUND_ERR, name: "Not found" });
  ...
  Entry.prototype = {
    ...
    getMetadata: function (successCallback, opt_errorCallback) {
      ...
      try {
        if (this.isFile) {
          ...
          opt_errorCallback(new MyFileError({ code: 1001, name: "getMetadata() not implemented for DirectoryEntry" }));
        }
      } catch (e) {
    ...
    toURL: function () {
      ...
      return "filesystem:" + origin + DIR_SEPARATOR + storageType_.toLowerCase() + this.fullPath;
    },
  };
    ...
    idb_.get(
      ...
      function (fileEntry) {
        ...
        if (options.create === true && options.exclusive === true && fileEntry) {
          ...
          fileEntry.file_ = new MyFile({ size: 0, name: fileEntry.name, lastModifiedDate: new Date() });
...
console.log("idb.filesystem is loaded");
